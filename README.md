...
pip install https://github.com/atomic-235/rocket_fuel_trading/archive/refs/tags/v0.1.1.tar.gz

# Or install with development dependencies
pip install "https://github.com/atomic-235/rocket_fuel_trading/archive/refs/tags/v0.1.1.tar.gz[dev]"
```
...
wget https://github.com/atomic-235/rocket_fuel_trading/archive/refs/tags/v0.1.1.tar.gz && \
tar -xzf v0.1.1.tar.gz && \
cd rocket_fuel_trading-0.1.1 && \
...
```bash
tail -f rocket_fuel_trading-0.1.1/trading.log
```

> **Note**: Replace `v0.1.1` with the latest release version from [GitHub Releases](https://github.com/atomic-235/rocket_fuel_trading/releases)
...
# Restart the service (from rocket_fuel_trading-0.1.1 directory)
cd rocket_fuel_trading-0.1.1 && \
nohup env TELEGRAM_BOT_TOKEN="your_bot_token" \
          TELEGRAM_CHAT_IDS="your_chat_ids" \
          OWNER_TELEGRAM_ID="your_telegram_id" \
